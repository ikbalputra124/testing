...
<div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
  <div class="w-full max-w-md space-y-8">
    <div>
      <img class="mx-auto h-12 w-auto" src="image/pamer.png" alt="Your Company">
      <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Masuk ke akun anda</h2>
      <p class="mt-2 text-center text-sm text-gray-600">
        atau
        <a href="form3.php" class="font-medium text-indigo-600 hover:text-indigo-500">Daftar</a>
      </p>
    </div>
    <form class="mt-8 space-y-6" action="#" method="POST">
      ...
      <div class="-space-y-px rounded-md shadow-sm">
        <div>
          <label for="email-address" class="sr-only">Masukan alamat email</label>
